...
var _chunkIUOPPN2Njs = require('./chunk-IUOPPN2N.js');
...
// src/programmers/notations/NotationGeneralProgrammer.ts
var _typescript = require('typescript'); var _typescript2 = _interopRequireDefault(_typescript);
var NotationGeneralProgrammer;
(function(NotationGeneralProgrammer2) {
  NotationGeneralProgrammer2.returnType = (rename) => (type) => `typia.${_chunkRV4Y6B6Tjs.StringUtil_exports.capitalize(rename.name)}Case<${type}>`;
  NotationGeneralProgrammer2.write = (rename) => (project) => (modulo) => {
  ...
  const decode_array_inline = /* @__PURE__ */ _chunkUZ5BS2M3js.__name.call(void 0, (config) => (importer) => (input, array, explore) => _chunkFWJ4HRE5js.FeatureProgrammer.decode_array(config)(importer)(_chunkIUOPPN2Njs.NotationJoiner.array)(input, array, explore), "decode_array_inline");
  ...
  const decode_tuple_inline = /* @__PURE__ */ _chunkUZ5BS2M3js.__name.call(void 0, (project) => (config) => (importer) => (input, tuple, explore) => {
    ...
    return _chunkIUOPPN2Njs.NotationJoiner.tuple(children, rest);
  }, "decode_tuple_inline");
  const decode_native = /* @__PURE__ */ _chunkUZ5BS2M3js.__name.call(void 0, (type) => (input) => type === "Date" ? _typescript2.default.factory.createNewExpression(_typescript2.default.factory.createIdentifier(type), void 0, [
    input
  ]) : input, "decode_native");
  ...
  const PREFIX = "$c";
  const configure = /* @__PURE__ */ _chunkUZ5BS2M3js.__name.call(void 0, (rename) => (project) => (importer) => {
    const config = {
      types: {
        ...
        output: /* @__PURE__ */ _chunkUZ5BS2M3js.__name.call(void 0, (type, name) => _typescript2.default.factory.createTypeReferenceNode(NotationGeneralProgrammer2.returnType(rename)(_nullishCoalesce(name, () => ( _chunkPK6R5VEJjs.TypeFactory.getFullName(project.checker)(type))))), "output")
      },
      prefix: PREFIX,
      trace: false,
      path: false,
      ...
      objector: {
        ...
        joiner: _chunkIUOPPN2Njs.NotationJoiner.object(rename),
...
})(NotationGeneralProgrammer || (NotationGeneralProgrammer = exports.NotationGeneralProgrammer = {}));



exports.NotationGeneralProgrammer = NotationGeneralProgrammer;
//# sourceMappingURL=chunk-M3M3GCBS.js.map