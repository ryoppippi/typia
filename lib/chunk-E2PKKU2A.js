...
(function(HttpQueryProgrammer2) {
  ...
  HttpQueryProgrammer2.write = (project) => (modulo) => (type, name) => {
    ...
    return _typescript2.default.factory.createArrowFunction(void 0, void 0, [
      _chunkUUZFPK7Njs.IdentifierFactory.parameter("input", _typescript2.default.factory.createTypeReferenceNode(HttpQueryProgrammer2.INPUT_TYPE))
  ...
  const decode_object = /* @__PURE__ */ _chunkUZ5BS2M3js.__name.call(void 0, (importer) => (object) => {
    ...
    return [
      _typescript2.default.factory.createExpressionStatement(_typescript2.default.factory.createBinaryExpression(input, _typescript2.default.factory.createToken(_typescript2.default.SyntaxKind.EqualsToken), _typescript2.default.factory.createAsExpression(_typescript2.default.factory.createCallExpression(importer.use("params"), void 0, [
        input
      ]), _typescript2.default.factory.createTypeReferenceNode("URLSearchParams")))),
...
})(HttpQueryProgrammer || (HttpQueryProgrammer = exports.HttpQueryProgrammer = {}));



exports.HttpQueryProgrammer = HttpQueryProgrammer;
//# sourceMappingURL=chunk-E2PKKU2A.js.map