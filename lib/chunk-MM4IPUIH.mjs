...
(function(NotationJoiner2) {
  ...
  NotationJoiner2.array = (input, arrow) => ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(input, "map"), void 0, [
    arrow
  ]);
...
//# sourceMappingURL=chunk-MM4IPUIH.mjs.map