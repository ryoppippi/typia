...
var Metadata = class _Metadata {
  ...
  name_;
  /** @internal */
  parent_resolved_ = false;
  /** @internal */
  union_index;
  /** @internal */
  fixed_;
  /** @internal */
  boolean_literal_intersected_;
  /* -----------------------------------------------------------
    CONSTRUCTORS
  ----------------------------------------------------------- */
  /**
...
(function(Metadata2) {
  ...
  Metadata2.covers = (x, y, level = 0, escaped = false) => {
    ...
    for (const yo of y.objects) if (x.objects.some((xo) => MetadataObject.covers(xo, yo)) === false) return false;
  ...
  Metadata2.merge = (x, y) => {
    const output = Metadata2.create({
      ...
      atomics: mergeTaggedTypes({
        container: x.atomics,
        equals: /* @__PURE__ */ __name((x2, y2) => x2.type === y2.type, "equals"),
        getter: /* @__PURE__ */ __name((x2) => x2.tags, "getter")
      })(y.atomics),
      constants: [
        ...x.constants
      ],
      templates: x.templates.slice(),
      rest: x.rest !== null && y.rest !== null ? Metadata2.merge(x.rest, y.rest) : x.rest ?? y.rest,
      // arrays: x.arrays.slice(),
      arrays: mergeTaggedTypes({
        container: x.arrays,
        equals: /* @__PURE__ */ __name((x2, y2) => x2.type.name === y2.type.name, "equals"),
        getter: /* @__PURE__ */ __name((x2) => x2.tags, "getter")
      })(y.arrays),
    ...
    for (const constant of y.constants) {
      ...
      for (const value of constant.values) ArrayUtil.add(target.values, value, (a, b) => a.value === b.value);
    }
    for (const obj of y.objects) ArrayUtil.set(output.objects, obj, (elem) => elem.name);
    for (const alias of y.aliases) ArrayUtil.set(output.aliases, alias, (elem) => elem.name);
    return output;
  };
})(Metadata || (Metadata = {}));
var getName = /* @__PURE__ */ __name((metadata) => {
...
var mergeTaggedTypes = /* @__PURE__ */ __name((props) => (opposite) => {
  const output = [
    ...props.container
  ];
...
//# sourceMappingURL=chunk-RD644GUB.mjs.map