...
(function(ProtobufValidateEncodeProgrammer2) {
  ProtobufValidateEncodeProgrammer2.write = (project) => (modulo) => (type, name) => _typescript2.default.factory.createArrowFunction(void 0, void 0, [
  ...
  ], _typescript2.default.factory.createTypeReferenceNode("typia.IValidation<Uint8Array>"), void 0, _typescript2.default.factory.createBlock([
