...
(function(CloneJoiner2) {
  ...
  CloneJoiner2.array = (input, arrow) => _typescript2.default.factory.createCallExpression(_typescript2.default.factory.createPropertyAccessExpression(input, "map"), void 0, [
    arrow
  ]);
})(CloneJoiner || (CloneJoiner = exports.CloneJoiner = {}));



exports.CloneJoiner = CloneJoiner;
//# sourceMappingURL=chunk-LGDPYC5C.js.map