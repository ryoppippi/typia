...
(function(HttpValidateFormDataProgrammer2) {
  HttpValidateFormDataProgrammer2.write = (project) => (modulo) => (type, name) => ts.factory.createArrowFunction(void 0, void 0, [
...
})(HttpValidateFormDataProgrammer || (HttpValidateFormDataProgrammer = {}));

export {
  HttpValidateFormDataProgrammer
};
//# sourceMappingURL=chunk-RZPF5GBX.mjs.map