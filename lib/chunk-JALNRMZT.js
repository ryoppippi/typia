...
(function(JsonValidateStringifyProgrammer2) {
  JsonValidateStringifyProgrammer2.write = (project) => (modulo) => (type, name) => _typescript2.default.factory.createArrowFunction(void 0, void 0, [
  ...
  ], _typescript2.default.factory.createTypeReferenceNode("typia.IValidation<string>"), void 0, _typescript2.default.factory.createBlock([
