...
(function(JsonIsStringifyProgrammer2) {
  JsonIsStringifyProgrammer2.write = (project) => (modulo) => (type, name) => _typescript2.default.factory.createArrowFunction(void 0, void 0, [
    ...
    _chunkPK6R5VEJjs.TypeFactory.keyword("string"),
    ...
    ]), void 0, _typescript2.default.factory.createCallExpression(_typescript2.default.factory.createIdentifier("stringify"), void 0, [
      _typescript2.default.factory.createIdentifier("input")
    ]), void 0, _typescript2.default.factory.createNull()))
  ]));
})(JsonIsStringifyProgrammer || (JsonIsStringifyProgrammer = exports.JsonIsStringifyProgrammer = {}));



exports.JsonIsStringifyProgrammer = JsonIsStringifyProgrammer;
//# sourceMappingURL=chunk-T6QGHBPU.js.map